...
public class BunnyEarsModel<T extends LivingEntity> extends BipedModel<T>
{
	...
	public BunnyEarsModel() {
		...
		Headgear1.setTextureOffset(6, 6).addBox(0.1841F, -15.3959F, 0.0F, 3.0F, 8.0F, 0.0F, 0.0F, false);
		...
		Headgear2.setTextureOffset(0, 0).addBox(-3.1841F, -15.3959F, 0.0F, 3.0F, 8.0F, 0.0F, 0.0F, false);
