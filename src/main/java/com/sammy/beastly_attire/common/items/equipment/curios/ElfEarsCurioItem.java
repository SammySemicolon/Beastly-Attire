...
public class ElfEarsCurioItem extends Item implements ICurio
{
    public ElfEarsCurioItem(Properties builder)
    {
        super(builder);
    }
    public final ResourceLocation texture = BeastlyAttireHelper.prefix("textures/armor/elf_ears.png");
    public ElfEarsModel<LivingEntity> model;
