...
public class WizardArmorItem extends ArmorItem
{
    ...
    public WizardArmorItem(IArmorMaterial materialIn, EquipmentSlotType slot, Properties builder)
    {
        super(materialIn, slot, builder);
    
        if (FMLEnvironment.dist == Dist.CLIENT)
        {
            this.model = DistExecutor.runForDist(() -> () -> new LazyValue<>(() -> new ModelWizardArmor(slot)), () -> () -> null);
        }
    }
    ...
    {
        return "beastly_attire:textures/armor/wizard_armor.png";
    }
}