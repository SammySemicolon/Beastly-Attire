...
public class HeadFlowerCurioItem extends Item implements ICurio
{
    public HeadFlowerCurioItem(Properties builder)
    {
        super(builder);
    }

    public final ResourceLocation texture = BeastlyAttireHelper.prefix("textures/armor/head_flower.png");
    public HeadFlowerModel<LivingEntity> model;
    @Override
    public ICapabilityProvider initCapabilities(ItemStack stack, CompoundNBT unused)
    {
        return CurioProvider.createProvider(new ICurio()
        {
            ...
            public void render(String identifier, int index, MatrixStack matrixStack, IRenderTypeBuffer renderTypeBuffer, int light, LivingEntity livingEntity, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch)
            {
                ...
                if (model == null)
                {
                    model = new HeadFlowerModel<>();
                }
                ICurio.RenderHelper.followHeadRotations(livingEntity, model.headFlower);
