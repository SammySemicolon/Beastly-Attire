...
import com.sammy.beastly_attire.client.models.GoldChainModel;
...
public class GoldChainCurioItem extends Item implements ICurio
{
    public GoldChainCurioItem(Properties builder)
    {
        super(builder);
    }
    
    public final ResourceLocation texture = BeastlyAttireHelper.prefix("textures/armor/gold_chain.png");
    public GoldChainModel<LivingEntity> model;
    @Override
